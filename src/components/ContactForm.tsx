  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-slate-900 rounded-3xl shadow-2xl p-8 max-w-md w-full text-center transform scale-100 animate-in zoom-in-95 duration-200 border border-slate-700">
        ...
        <button
          onClick={onClose}
          className="w-full bg-[#e91e63] text-white py-3.5 rounded-xl font-black text-lg hover:bg-[#d81b60] transition-colors shadow-lg shadow-pink-600/20 cursor-pointer uppercase tracking-widest"
        >
          Entendido
        </button>
      </div>
